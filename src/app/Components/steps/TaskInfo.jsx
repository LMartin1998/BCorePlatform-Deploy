...
export default function TaskInfo() {
  ...
  const mechanicalTasks = [
    ...
    {
      label: "Pile Remediation",
      value: "Pile Remediation",
      parent: "Mechanical",
    },
    {
      label: "Pile Caps Installation",
      value: "Pile Caps Installation",
      parent: "Mechanical",
    },
    {
      label: "Pre-Installing Bearings",
      value: "Pre-Installing Bearings",
      parent: "Mechanical",
    },
  ];
  ...
  const electricalTasks = [
    {
      label: "10KV Meg Testing Before Landing MV-DC",
      value: "10KV Meg Testing Before Landing MV-DC",
      parent: "Electrical",
    },
    {
      label: "MEG TEST First lift",
      value: "MEG TEST First lift",
      parent: "Electrical",
    },
    { label: "Grounding", value: "Grounding", parent: "Electrical" },
    {
      label: "DC/MV Road Crossing",
      value: "DC/MV Road Crossing",
      parent: "Electrical",
    },
  ];
